  ...
  return (
    <>
      <div className='h-screen relative flex justify-center'>
        ...
        <div className='absolute top-1/2 my-auto mx-auto'>
        ...
        <p className=' font-montserrat max-w-2xl py-4 text-center hover:scale-105 transition-all'>Sianjur Mulamula adalah sebuah kecamatan yang berada di Kabupaten Samosir, provinsi Sumatra Utara, Indonesia. Ibu kota kecamatan ini berada di desa Ginolat. Sianjur Mulamula terletak di jalan utama yang menghubungi Doloksanggul dan Sidikalang.</p>
        </div>
      </div>

      <div className='h-screen bg-white p-[5%]'>
        <h1 className='text-3xl sm:text-6xl smm-title mx-auto font-made-sunflower text-smm-red stroke-white hover:scale-110 transition-all'>Profil Desa</h1>
